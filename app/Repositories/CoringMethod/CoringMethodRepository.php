...
class CoringMethodRepository implements CoringMethodRepositoryInterface
{
    public function getObjs()
    {
        $objs = CoringMethod::all();
        return $objs;
    }
    ...
    public function getArrays()
    {
         ...
         */
        $table_name = (new CoringMethod())->getTable();
    ...
    public function create($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            $returnObj['statusMessage'] = "Coring Method is successfully created";
            return $returnObj;
        } catch (\Exception $e) {
    ...
    public function update($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            /* set status to success and return */
            $returnObj['statusCode'] = ReturnMessage::OK;
            $returnObj['statusMessage'] = "Coring Method is successfully updated";
            return $returnObj;
        } catch (\Exception $e) {
            /* there is an exception,
            get error message and return */
    ...
    public function destroy($id)
    {
        ...
        */
        ...
        try {
            ...
            $tempObj = CoringMethod::findOrFail($id);
    ...
    public function getObjByID($id)
    {
        ...
        $result = CoringMethod::findOrFail($id);
        return $result;
    }
}
