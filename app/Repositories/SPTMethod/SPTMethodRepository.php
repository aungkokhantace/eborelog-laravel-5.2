...
namespace App\Repositories\SPTMethod;
...
class SPTMethodRepository implements SPTMethodRepositoryInterface
{
    ...
    public function getArrays()
    {
         ...
         */
        $table_name = (new SPTMethod())->getTable();
    ...
    public function create($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            $returnObj['statusMessage'] = "SPT Method is successfully created";
            return $returnObj;
        } catch (\Exception $e) {
    ...
    public function update($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            /* set status to success and return */
            $returnObj['statusCode'] = ReturnMessage::OK;
            $returnObj['statusMessage'] = "SPT Method is successfully updated";
            return $returnObj;
        } catch (\Exception $e) {
            /* there is an exception,
            get error message and return */
    ...
    public function destroy($id)
    {
        ...
        */
        ...
        try {
            ...
            $tempObj = SPTMethod::findOrFail($id);
    ...
    public function getObjByID($id)
    {
        ...
        $result = SPTMethod::findOrFail($id);
        return $result;
    }
}
