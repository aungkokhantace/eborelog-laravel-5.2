...
class DrillingMethodRepository implements DrillingMethodRepositoryInterface
{
    public function getObjs()
    {
        $objs = DrillingMethod::all();
        return $objs;
    }
    ...
    public function getArrays()
    {
         ...
         */
        $table_name = (new DrillingMethod())->getTable();
    ...
    public function create($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            $returnObj['statusMessage'] = "Drilling Method is successfully created";
            return $returnObj;
        } catch (\Exception $e) {
    ...
    public function update($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            /* set status to success and return */
            $returnObj['statusCode'] = ReturnMessage::OK;
            $returnObj['statusMessage'] = "Drilling Method is successfully updated";
            return $returnObj;
        } catch (\Exception $e) {
            /* there is an exception,
            get error message and return */
    ...
    public function destroy($id)
    {
        ...
        */
        ...
        try {
            ...
            $tempObj = DrillingMethod::findOrFail($id);
            ...
            $delete_result = DrillingMethod::destroy($id);

            if ($delete_result > 0) {
                /* if delete_result is greater than 0, this means record is deleted,
                set statusCode to success, and return */
                $returnObj['statusCode'] = ReturnMessage::OK;
                $returnObj['statusMessage'] = "Drilling Method is successfully deleted";
                return $returnObj;
            } else {
                /* Record is not deleted,
                return with above-predefined INTERNAL_SERVER_ERROR */
                $returnObj['statusMessage'] = "Drilling Method is not deleted";
                return $returnObj;
            }
        } catch (\Exception $e) {
    ...
    public function getObjByID($id)
    {
        ...
        $result = DrillingMethod::findOrFail($id);
        return $result;
    }
}
