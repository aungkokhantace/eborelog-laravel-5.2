...
class DrillingRigRepository implements DrillingRigRepositoryInterface
{
    public function getObjs()
    {
        $objs = DrillingRig::all();
        return $objs;
    }
    ...
    public function getArrays()
    {
         ...
         */
        $table_name = (new DrillingRig())->getTable();
    ...
    public function create($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            $returnObj['statusMessage'] = "Drilling Rig is successfully created";
            return $returnObj;
        } catch (\Exception $e) {
    ...
    public function update($paramObj)
    {
        ...
        */
        ...
        try {
            ...
            /* set status to success and return */
            $returnObj['statusCode'] = ReturnMessage::OK;
            $returnObj['statusMessage'] = "Drilling Rig is successfully updated";
            return $returnObj;
        } catch (\Exception $e) {
            /* there is an exception,
            get error message and return */
    ...
    public function destroy($id)
    {
        ...
        */
        ...
        try {
            ...
            $tempObj = DrillingRig::findOrFail($id);
    ...
    public function getObjByID($id)
    {
        ...
        $result = DrillingRig::findOrFail($id);
        return $result;
    }
}
