...
class ProjectEditRequest extends FormRequest
{
    ...
    {
        return [
            'project_id' => 'required|unique:projects,project_id,' . $this->get('id') . ',id,deleted_at,NULL',
            'name' => 'required|unique:projects,name,' . $this->get('id') . ',id,deleted_at,NULL',
            'client_name' => 'required',
            'contract_number' => 'required|unique:projects,contract_number,' . $this->get('id') . ',id,deleted_at,NULL',
