...
class DrillerEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'name'           => 'required',
            'nric'           => 'required|numeric|unique:drillers,nric,' . $this->get('id') . ',id,deleted_at,NULL',
            'permit_no'      => 'required|numeric|unique:drillers,permit_no,' . $this->get('id') . ',id,deleted_at,NULL',
